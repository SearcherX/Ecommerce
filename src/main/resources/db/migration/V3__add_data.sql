...
VALUES ('14.1" Ноутбук Digma EVE 14 C411 серый', 'laptop-digma-eve-14',
       ...
       ('11.6" Ноутбук ASUS Laptop 11 E210MA-GJ151T черный', 'asus-laptop-11',
        ...
        23999, 0, '2022-12-16', (SELECT id FROM subcategory_t WHERE subcategory_name = 'Ноутбуки и аксессуары')),
       ...
       ('14" Ноутбук ASUS Laptop 14 F415MA-EK582W серый', 'asus-laptop-14',
        ...
        0, '2022-12-18', (SELECT id FROM subcategory_t WHERE subcategory_name = 'Ноутбуки и аксессуары')),
       ...
       ('14" Ноутбук ASUS VivoBook 14 E410MA-BV1502W черный', 'laptop-asus-vivobook-14',
        ...
        '2022-12-17', (SELECT id FROM subcategory_t WHERE subcategory_name = 'Ноутбуки и аксессуары')),
